# Для работы необходимо установить одну внешнюю библиотеку Telebot ERPEORPK FERFKOP
...
bot = telebot.TeleBot(token= 'сам токен'
, parse_mode='html')
